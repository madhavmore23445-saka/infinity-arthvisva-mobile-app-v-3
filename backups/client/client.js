...
const ClientPortfolioScreen = () => {
    ...
    // reset product when categoty changes
    useEffect(() => {
    ...
    const filteredLeads = leads.filter(item => {
        ...
        const matchesSearch =
            (item.leads_name && item.toLocaleLowerCase().includes(query)) ||
            (item.lead_id && item.lead_id.toLocaleLowerCase().includes(query)) ||
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <View style={styles.content}>
                  ...
                  {/* Search Bar */}
                  <View st={styles.searchContainer}>
                 ...
                 <View style={style.tabsContainer}>
                    {tabs.map(tab =>(
                        ...
                        >
                            ...
                            <View style={[styles.countBadge , activeTab === tab.id ? styles.activeCountBadge : styles.inactiveCountBadge ]}>
                                <Text style={[styles.countText,activeTab === tab.id ? styles.activeCountText : styles.inactiveCountText ]}>
